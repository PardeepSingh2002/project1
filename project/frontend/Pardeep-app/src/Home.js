        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
                <h1  data-aos="zoom-in" style={{fontFamily:'times new roman', fontSize:"70px", marginTop:"-35%",fontWeight:'bolder'}}>Welcome to Himachal Pradesh</h1>
...
<div className="row">
    ...
    <div className="row" >
     ...
     style={{listStyle:"none",fontSize:'20px',fontFamily:'times new roman'}}><li style={{fontSize:'40px',fontFamily:"Lucida Handwriting",fontWeight:"bolder",color:"white"}}>Address</li>
      ...
      <li style={{color:"white"}}>Vill.ghanour,Teh.Rajpura (PB),Punjab,Pin-140417,IND</li><br></br>
      <li style={{color:"white",fontSize:'30px'}}>Help Line No.</li>
      <li style={{color:"white"}}><u>9817668496</u></li>
      <li style={{color:"white"}}><u>8059614325</u></li>
</ul></div>
      </div>
